...
<%
    ...
    if (endpointName != null && action != null) {
        try {
            if (!"".equals(action) && action.equals("enableStat")) {
                client.enableStatistics(endpointName);
            } else if (!"".equals(action) && action.equals("disableStat")) {
                client.disableStatistics(endpointName);
            }
        } catch (Exception ex) {
